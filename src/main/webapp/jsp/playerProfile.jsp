  ...
  <div class="sidebar col-3">
      ...
      <div class="request">
          ...
          <div id="mainRequest" class="col-6">
              ...
              <span>
                    <a href="/quat?action=accept_request&account_id=${requestScope['id']}&request_id=${request.getId()}&name_user=${request.getUserName()}&hours=${request.getHours()}&des=${request.getDescription()}&coin=${requestScope['coin']}"><button>Đồng ý</button></a>
                    <a href="/quat?action=refuse_request&account_id=${requestScope['id']}&request_id=${request.getId()}&name_user=${request.getUserName()}&hours=${request.getHours()}&des=${request.getDescription()}&coin=${requestScope['coin']}"><button>Huỷ</button></a>
              </span>
          </div>
      </div>
      </c:forEach>
